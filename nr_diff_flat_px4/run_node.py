"""Entry point for the Newton-Raphson Differential-Flatness control ROS2 node."""
...
def create_parser():
    ...
    parser = argparse.ArgumentParser(
        description='Newton-Raphson Diff-Flat Offboard Control for Quadrotor',
...
def generate_log_filename(args) -> str:
    ...
    Examples:
        ...
        sim_nr_df_numpy_circle_horz_1x.csv
        hw_nr_df_jax_fig8_vert_2x_short.csv
    """
    parts = []
    ...
    # Controller type
    parts.append(args.ctrl_type)  # 'jax' or 'numpy'
...
def main():
    ...
    # Print configuration
    print("\n" + "=" * 60)
    print("Newton-Raphson Diff-Flat Offboard Control Configuration")
    print("=" * 60)
